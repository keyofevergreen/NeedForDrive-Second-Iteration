...
const OrderStatusEdit = () => {
  ...
  const onSubmit = async data => {
    if (orderStatusId) {
      dispatch((0,_store_Edit_thunks__WEBPACK_IMPORTED_MODULE_9__.editEntity)(data, 'orderStatus', orderStatusId, 'Статус заказа сохранен'));
    } else dispatch((0,_store_Edit_thunks__WEBPACK_IMPORTED_MODULE_9__.createEntity)(data, 'orderStatus', 'Статус заказа создан'));
  };

  const onDeleteOrderStatus = () => {
    if (orderStatusId) {
      dispatch((0,_store_Edit_thunks__WEBPACK_IMPORTED_MODULE_9__.deleteEntity)('orderStatus', orderStatusId, 'Статус заказа удален'));
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("25de1823dd995f926454")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.d7193294cfd1b57bce1a.hot-update.js.map