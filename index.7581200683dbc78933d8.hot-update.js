...
const useCarById = (carId, setValue) => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (cars) {
      ...
      setValue('name', car.name);
      const blob = fetch(car.thumbnail.path).then(r => r.blob()).then(blob => {
        const carImage = new File([blob], car.thumbnail.originalname);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("b782ff0ce83c7d0b7836")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.7581200683dbc78933d8.hot-update.js.map