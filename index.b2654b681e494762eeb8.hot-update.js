...
const useSaveCar = (form, carId) => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (form) {
      ...
      const ImageFileWithBase64Path = (0,_utils_helpers_getBase64__WEBPACK_IMPORTED_MODULE_4__["default"])(form.thumbnail[0], result => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (body !== null) {
      if (carId) {
        ...
        console.log(body.get('thumbnail')); // dispatch(createCar(body));
      }
    }
  }, [body]);
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("c92aa5ddccd192d1f6a5")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.b2654b681e494762eeb8.hot-update.js.map