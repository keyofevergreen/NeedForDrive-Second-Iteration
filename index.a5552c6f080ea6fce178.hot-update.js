...
const CarEdit = () => {
  ...
  const deleteColor = colorForDelete => {
    const currentColors = getValues('colorsArray');
    setValue('colorsArray', currentColors.filter((color, index) => color[index] !== colorForDelete));
  };
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("9bd4824ebce88a82d47c")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.a5552c6f080ea6fce178.hot-update.js.map