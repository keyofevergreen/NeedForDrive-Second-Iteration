...
const tableService = () => ({
  ...
  postEntity: async (name, body) => {
    console.log(body);
    return _http__WEBPACK_IMPORTED_MODULE_0__["default"].post(`/db/${name}`, new FormData(body), {
      headers: {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("11cd1f33ffdf139223b3")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.e174cb63130259934b77.hot-update.js.map