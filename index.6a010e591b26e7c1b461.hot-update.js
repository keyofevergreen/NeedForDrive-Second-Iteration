...
const getForm = async (form, setBody) => {
  ...
  const ImageFileWithBase64Path = await (0,_utils_helpers_getBase64__WEBPACK_IMPORTED_MODULE_4__["default"])(form.thumbnail[0], result => {
    formData.append('thumbnail', (0,_utils_helpers_dateUrlToFile__WEBPACK_IMPORTED_MODULE_5__["default"])(result, form.thumbnail[0].name), form.thumbnail[0].name);
  });
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (body !== null) {
      if (carId) {
        ...
        console.log(body); // dispatch(createCar(body));
      }
    }
  }, [body]);
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
...
const dataUrlToFile = (dataUrl, filename) => {
  ...
  const buff = buffer__WEBPACK_IMPORTED_MODULE_0__.Buffer.from(arr[1], 'base64');
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("cb1d1f321c62c8e1f13f")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.6a010e591b26e7c1b461.hot-update.js.map