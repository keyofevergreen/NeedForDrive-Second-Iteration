  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (form) {
      ...
      (0,_utils_helpers_toBase64__WEBPACK_IMPORTED_MODULE_4__["default"])(form.thumbnail[0]).then(result => {
        // formData.append('thumbnail', result.toString());
        console.log(form);
        console.log(result); // setBody({...form, thumbnail: result});
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("2a7e61358e9f7873b148")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.6884be40574b23fb5ada.hot-update.js.map