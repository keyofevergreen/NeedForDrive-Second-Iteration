...
const useSaveCar = (form, carId) => {
  ...
  const convertedImage = useConvertFile(form === null || form === void 0 ? void 0 : form.thumbnail[0]);
  const [body, setBody] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null);
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    convertedImage.then(result => console.log(result, typeof result)).catch(e => console.error(e));
  }, [form]);
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (form) {
      ...
      formData.append('thumbnail', carImage, carImage.name); // setBody(formData);
    }
  }, [form]);
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (body !== null) {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("96d4885cbcf6b9f950c1")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.18c2ae37a21cc5eb7450.hot-update.js.map