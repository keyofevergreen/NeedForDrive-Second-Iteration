...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".success-alert-message___FUTuN {\n  border-radius: 0;\n  border: none;\n  width: 100%;\n}\n.success-alert-message___FUTuN .toast-header {\n  background-color: var(--green);\n  color: #fff;\n  font-size: 13px;\n  border: none;\n  display: flex;\n  align-items: center;\n  gap: 10px;\n  padding: 14px 27px;\n}\n.success-alert-message___FUTuN .toast-header svg {\n  height: 10px;\n}\n.success-alert-message___FUTuN .toast-header svg path {\n  fill: #fff;\n}", "",{"version":3,"sources":["webpack://./src/pages/Edit/styles.module.scss"],"names":[],"mappings":"AAAA;EACE,gBAAA;EACA,YAAA;EACA,WAAA;AACF;AAEI;EACE,8BAAA;EACA,WAAA;EACA,eAAA;EACA,YAAA;EACA,aAAA;EACA,mBAAA;EACA,SAAA;EACA,kBAAA;AAAN;AACM;EACE,YAAA;AACR;AAAQ;EACE,UAAA;AAEV","sourcesContent":[".success-alert-message {\n  border-radius: 0;\n  border: none;\n  width: 100%;\n\n  :global {\n    .toast-header {\n      background-color: var(--green);\n      color: #fff;\n      font-size: 13px;\n      border: none;\n      display: flex;\n      align-items: center;\n      gap: 10px;\n      padding: 14px 27px;\n      svg {\n        height: 10px;\n        path {\n          fill: #fff;\n        }\n      }\n    }\n  }\n}\n"],"sourceRoot":""}]);
// Exports
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("86cbcec4f8a0cde649f7")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.758e4555667f75c192ba.hot-update.js.map