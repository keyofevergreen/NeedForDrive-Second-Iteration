...
const CarEdit = () => {
  ...
  const onDeleteCar = () => {
    if (carId) {
      dispatch((0,_store_Cars_thunks__WEBPACK_IMPORTED_MODULE_8__.deleteCar)(carId));
      navigate('/car');
    }
  };
...
const editCar = (car, carId) => {
  return async (dispatch, getState, {
    ...
    try {
      ...
      const {
        data
      } = await services.table.putEntity('car', car, carId);
      dispatch((0,_Edit_actions__WEBPACK_IMPORTED_MODULE_2__.uploadEntitySuccess)(data.data));
...
const deleteCar = carId => {
  return async (dispatch, getState, {
    ...
    try {
      ...
      const {
        data
      } = await services.table.deleteEntity('car', carId);
      dispatch((0,_Edit_actions__WEBPACK_IMPORTED_MODULE_2__.uploadEntitySuccess)(data.data));
      dispatch((0,_ErrorProvider_actions__WEBPACK_IMPORTED_MODULE_1__.addSuccessAlert)('Машина удалена'));
    } catch (error) {
      dispatch((0,_Edit_actions__WEBPACK_IMPORTED_MODULE_2__.uploadEntityError)(error.response.status));
      dispatch((0,_ErrorProvider_actions__WEBPACK_IMPORTED_MODULE_1__.addToErrorHandler)(error.response.status));
    }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("da43f135640af9f82060")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.a8d1a1269d5a942fe656.hot-update.js.map