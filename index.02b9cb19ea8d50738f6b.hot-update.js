...
const CarEdit = () => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    const progressBarState = [errors.car, errors.category, errors.colorsArray];
    console.log('Количество стейтов', progressBarState.length);
    console.log('Заполненные стейты');
  }, [errors]);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("721615d91578782bd0b9")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.02b9cb19ea8d50738f6b.hot-update.js.map