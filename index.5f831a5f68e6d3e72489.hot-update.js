...
const useSaveCar = (form, carId) => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (form) {
      const formData = new FormData(form); // formData.append('name', form.name);
      ...
      console.log(formData.get('thumbnail')); // setBody(formData);
    }
  }, [form]);
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (body !== null) {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("08d4b6eeb22d5e48f93c")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.5f831a5f68e6d3e72489.hot-update.js.map