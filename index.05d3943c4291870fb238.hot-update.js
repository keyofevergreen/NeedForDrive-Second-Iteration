...
const CarEdit = () => {
  ...
  const onDeleteCar = () => {
    if (carId) {
      dispatch((0,_store_Edit_thunks__WEBPACK_IMPORTED_MODULE_12__.deleteEntity)(carId, 'Машина удалена'));
      navigate('/car');
    }
  };
...
const OrderStatusEdit = () => {
  ...
  const onDeleteOrderStatus = () => {
    if (orderStatusId) {
      dispatch((0,_store_Edit_thunks__WEBPACK_IMPORTED_MODULE_9__.deleteEntity)(orderStatusId, 'Статус заказа удален'));
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("d7193294cfd1b57bce1a")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.05d3943c4291870fb238.hot-update.js.map