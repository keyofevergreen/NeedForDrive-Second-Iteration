...
/* harmony export */   "editEntity": () => (/* binding */ editEntity),
...
const createEntity = (entity, path, alertSuccessMessage) => {
  return async (dispatch, getState, {
    services
  }) => {
    try {
      dispatch((0,_actions__WEBPACK_IMPORTED_MODULE_0__.uploadEntity)());
      const {
        data
      } = await services.table.postEntity(path, entity);
      dispatch((0,_actions__WEBPACK_IMPORTED_MODULE_0__.uploadEntitySuccess)(data.data));
      dispatch((0,_actions__WEBPACK_IMPORTED_MODULE_0__.addSuccessAlertMessage)(alertSuccessMessage));
    } catch (error) {
      dispatch((0,_actions__WEBPACK_IMPORTED_MODULE_0__.uploadEntityError)(error.response.status));
      dispatch((0,_ErrorProvider_actions__WEBPACK_IMPORTED_MODULE_1__.addToErrorHandler)(error.response.status));
    }
  };
};
const editEntity = (entity, path, entityId, alertSuccessMessage) => {
  return async (dispatch, getState, {
    services
  }) => {
    try {
      ...
      const {
        data
      } = await services.table.putEntity(path, entity, entityId);
      dispatch((0,_actions__WEBPACK_IMPORTED_MODULE_0__.uploadEntitySuccess)(data.data));
      dispatch((0,_actions__WEBPACK_IMPORTED_MODULE_0__.addSuccessAlertMessage)(alertSuccessMessage));
    } catch (error) {
      dispatch((0,_actions__WEBPACK_IMPORTED_MODULE_0__.uploadEntityError)(error.response.status));
...
const deleteEntity = (path, entityId, alertSuccessMessage) => {
  return async (dispatch, getState, {
    services
  }) => {
    try {
      ...
      const {
        data
      } = await services.table.deleteEntity(path, entityId);
      dispatch((0,_actions__WEBPACK_IMPORTED_MODULE_0__.uploadEntitySuccess)(data.data));
      dispatch((0,_actions__WEBPACK_IMPORTED_MODULE_0__.addSuccessAlertMessage)(alertSuccessMessage));
    } catch (error) {
      dispatch((0,_actions__WEBPACK_IMPORTED_MODULE_0__.uploadEntityError)(error.response.status));
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("997fbb8cfb35e4581fcd")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.2d5a09dc900bd356cd38.hot-update.js.map