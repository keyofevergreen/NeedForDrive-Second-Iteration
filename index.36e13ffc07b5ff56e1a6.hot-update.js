...
const getForm = async (form, setBody) => {
  ...
  formData.append('categoryId', form.categoryId); // const ImageFileWithBase64Path = await getBase64(form.thumbnail[0], (result) => {
  //   formData.append('thumbnail', dataUrlToFile(result, form.thumbnail[0].name), form.thumbnail[0].name);
  // });

  console.log(formData); // await setBody(formData);
};
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("6a010e591b26e7c1b461")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.36e13ffc07b5ff56e1a6.hot-update.js.map