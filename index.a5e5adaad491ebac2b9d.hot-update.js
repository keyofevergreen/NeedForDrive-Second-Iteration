...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".edit-route___fWAKV {\n  position: relative;\n}\n\n.success-alert-message___FUTuN {\n  position: absolute;\n  top: 0;\n  border-radius: 0;\n  border: none;\n  min-width: 100%;\n}\n.success-alert-message___FUTuN .toast-body {\n  background-color: var(--green);\n  color: #fff;\n  font-size: 13px;\n  border: none;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding: 14px 27px;\n}\n.success-alert-message___FUTuN .toast-body > div > svg {\n  height: 10px;\n}\n.success-alert-message___FUTuN .toast-body > div > svg path {\n  fill: #fff;\n}\n.success-alert-message___FUTuN .toast-body span {\n  margin-left: 10px;\n}\n.success-alert-message___FUTuN .toast-body button {\n  width: 19.5px;\n  height: 19.5px;\n  border: none;\n  background-color: transparent;\n}\n.success-alert-message___FUTuN .toast-body button svg path {\n  width: 19.5px;\n  height: 19.5px;\n  fill: #fff;\n}", "",{"version":3,"sources":["webpack://./src/pages/Edit/styles.module.scss"],"names":[],"mappings":"AAAA;EACE,kBAAA;AACF;;AAEA;EACE,kBAAA;EACA,MAAA;EACA,gBAAA;EACA,YAAA;EACA,eAAA;AACF;AAEI;EACE,8BAAA;EACA,WAAA;EACA,eAAA;EACA,YAAA;EACA,aAAA;EACA,mBAAA;EACA,8BAAA;EACA,kBAAA;AAAN;AAEM;EACE,YAAA;AAAR;AAEQ;EACE,UAAA;AAAV;AAIM;EACE,iBAAA;AAFR;AAKM;EACE,aAAA;EACA,cAAA;EACA,YAAA;EACA,6BAAA;AAHR;AAKQ;EACE,aAAA;EACA,cAAA;EACA,UAAA;AAHV","sourcesContent":[".edit-route {\n  position: relative;\n}\n\n.success-alert-message {\n  position: absolute;\n  top: 0;\n  border-radius: 0;\n  border: none;\n  min-width: 100%;\n\n  :global {\n    .toast-body {\n      background-color: var(--green);\n      color: #fff;\n      font-size: 13px;\n      border: none;\n      display: flex;\n      align-items: center;\n      justify-content: space-between;\n      padding: 14px 27px;\n\n      & > div > svg {\n        height: 10px;\n\n        path {\n          fill: #fff;\n        }\n      }\n\n      span {\n        margin-left: 10px;\n      }\n\n      button {\n        width: 19.5px;\n        height: 19.5px;\n        border: none;\n        background-color: transparent;\n\n        svg path {\n          width: 19.5px;\n          height: 19.5px;\n          fill: #fff;\n        }\n      }\n    }\n  }\n}\n"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
	"edit-route": "edit-route___fWAKV",
...
const Edit = () => {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsxs)("div", {
    className: _styles_module_scss__WEBPACK_IMPORTED_MODULE_13__["default"]["edit-route"],
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)(react_bootstrap__WEBPACK_IMPORTED_MODULE_15__["default"], {
      show: show,
      className: _styles_module_scss__WEBPACK_IMPORTED_MODULE_13__["default"]["success-alert-message"] // delay={3000}
      ,
      onClose: () => setShow(false) // autohide
      ,
      animation: true,
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("afb61de7c5c3e1a4469d")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.a5e5adaad491ebac2b9d.hot-update.js.map