...
const getForm = async (form, setBody) => {
  ...
  const base64Image = await (0,_utils_helpers_getBase64__WEBPACK_IMPORTED_MODULE_4__["default"])(form.thumbnail[0], result => {
    formData.append('thumbnail', new File(result, form.thumbnail[0].name));
    console.log(new File(result, form.thumbnail[0].name));
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("dae0d4998bfbe75f64a4")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.19006b1c547953951a65.hot-update.js.map