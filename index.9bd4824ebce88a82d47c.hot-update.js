...
const CarEdit = () => {
  ...
  const deleteColor = colorForDelete => {
    const currentColors = getValues('colorsArray');
    setValue('colorsArray', currentColors.filter((color, index) => index !== colorForDelete));
  };
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("78797b6f00968a394de5")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.9bd4824ebce88a82d47c.hot-update.js.map