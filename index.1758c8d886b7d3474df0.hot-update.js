...
const CarEdit = () => {
  ...
  const uploadLoading = (0,_hooks__WEBPACK_IMPORTED_MODULE_5__.useUploadedCar)(carId, navigate);
  const {
    register,
    handleSubmit,
    watch,
...
const useUploadedCar = (carId, navigate) => {
  const dispatch = (0,react_redux__WEBPACK_IMPORTED_MODULE_1__.useDispatch)();
  const {
    uploadedCar,
    uploadedCarLoading
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("380c5e6cc413d2b81c9b")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.1758c8d886b7d3474df0.hot-update.js.map