...
const useSaveCar = (form, isEdit) => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (form) {
      ...
      formData.append('categoryId', form.categoryId); // setBody(formData);
    }
  }, [form]);
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    console.log(postCar);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("cecc9e8e823876b24b02")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.70f86f03815f69133309.hot-update.js.map