...
/* harmony import */ var _hooks__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./hooks */ "./src/pages/Edit/components/CityEdit/hooks.ts");
...
const CityEdit = () => {
  ...
  const fetchCityLoading = (0,_hooks__WEBPACK_IMPORTED_MODULE_4__.useCityById)(cityId, setValue);
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(react_helmet__WEBPACK_IMPORTED_MODULE_1__.Helmet, {
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(react_bootstrap__WEBPACK_IMPORTED_MODULE_12__["default"], {
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_components_FormBody_FormBody__WEBPACK_IMPORTED_MODULE_3__["default"], {
...
const useCityById = (cityId, setValue) => {
  ...
  const {
    cityById,
    cityByIdLoading
  } = (0,react_redux__WEBPACK_IMPORTED_MODULE_0__.useSelector)(state => state.cities);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "requestCities": () => (/* binding */ requestCities),
/* harmony export */   "requestCitiesSuccess": () => (/* binding */ requestCitiesSuccess),
/* harmony export */   "requestCitiesError": () => (/* binding */ requestCitiesError),
/* harmony export */   "requestCity": () => (/* binding */ requestCity),
/* harmony export */   "requestCitySuccess": () => (/* binding */ requestCitySuccess),
/* harmony export */   "requestCityError": () => (/* binding */ requestCityError)
/* harmony export */ });
/* harmony import */ var _reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @reduxjs/toolkit */ "./node_modules/@reduxjs/toolkit/dist/redux-toolkit.esm.js");

const requestCities = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__.createAction)('Cities is fetching...');
const requestCitiesSuccess = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__.createAction)('Cities has already fetched');
const requestCitiesError = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__.createAction)('Cities fetched with error');
const requestCity = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__.createAction)('City is fetching...');
const requestCitySuccess = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__.createAction)('City has already fetched');
const requestCityError = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__.createAction)('City fetched with error');
...
const fetchCities = () => async (dispatch, getState, {
  services
}) => {
  try {
    dispatch((0,_actions__WEBPACK_IMPORTED_MODULE_0__.requestCities)());
    const {
      data
    } = await services.table.getEntities('city', {});
    dispatch((0,_actions__WEBPACK_IMPORTED_MODULE_0__.requestCitiesSuccess)(data.data));
  } catch (error) {
    dispatch((0,_actions__WEBPACK_IMPORTED_MODULE_0__.requestCitiesError)(error.response.status));
    dispatch((0,_ErrorProvider_actions__WEBPACK_IMPORTED_MODULE_1__.addToErrorHandler)(error.response.status));
  }
};
const fetchCity = cityId => async (dispatch, getState, {
  services
}) => {
  try {
    dispatch((0,_actions__WEBPACK_IMPORTED_MODULE_0__.requestCity)());
    const {
      data
    } = await services.table.getEntities('city', {}, cityId);
    dispatch((0,_actions__WEBPACK_IMPORTED_MODULE_0__.requestCitySuccess)(data.data));
  } catch (error) {
    dispatch((0,_actions__WEBPACK_IMPORTED_MODULE_0__.requestCityError)(error.response.status));
    dispatch((0,_ErrorProvider_actions__WEBPACK_IMPORTED_MODULE_1__.addToErrorHandler)(error.response.status));
  }
};
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("0b5c6d10010c5e27f368")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.800231981a27356876be.hot-update.js.map