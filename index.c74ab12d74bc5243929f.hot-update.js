...
const CarEdit = () => {
  ...
  const [response, responseLoading] = (0,_hooks__WEBPACK_IMPORTED_MODULE_8__.useCreateEditCar)(form, !!carId);
  const {
    register,
    handleSubmit,
    watch,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "useCreateEditCar": () => (/* binding */ useCreateEditCar)
/* harmony export */ });
...
const useCreateEditCar = (form, isEdit) => {
  const dispatch = (0,react_redux__WEBPACK_IMPORTED_MODULE_0__.useDispatch)();
  const {
    postCar,
    postLoading,
    postError
  } = (0,react_redux__WEBPACK_IMPORTED_MODULE_0__.useSelector)(state => state.cars);
  const [body, setBody] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("d24e8858212e68c3d038")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.c74ab12d74bc5243929f.hot-update.js.map