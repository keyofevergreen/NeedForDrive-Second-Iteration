...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".success-alert-message___FUTuN {\n  border-radius: 0;\n  border: none;\n  background-color: var(--green);\n  color: #fff;\n  font-size: 13px;\n}\n.success-alert-message___FUTuN .toast-body svg {\n  height: 10px;\n}\n.success-alert-message___FUTuN .toast-body svg path {\n  fill: #fff;\n}", "",{"version":3,"sources":["webpack://./src/pages/Edit/styles.module.scss"],"names":[],"mappings":"AAAA;EACE,gBAAA;EACA,YAAA;EACA,8BAAA;EACA,WAAA;EACA,eAAA;AACF;AAGM;EACE,YAAA;AADR;AAEQ;EACE,UAAA;AAAV","sourcesContent":[".success-alert-message {\n  border-radius: 0;\n  border: none;\n  background-color: var(--green);\n  color: #fff;\n  font-size: 13px;\n\n  :global {\n    .toast-body {\n      svg {\n        height: 10px;\n        path {\n          fill: #fff;\n        }\n      }\n    }\n  }\n}\n"],"sourceRoot":""}]);
// Exports
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("0d85833a10b94ef5dfb2")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.d414cf36f17ea02401d4.hot-update.js.map