...
const getForm = async (form, setBody) => {
  ...
  const base64Image = await (0,_utils_helpers_getBase64__WEBPACK_IMPORTED_MODULE_4__["default"])(form.thumbnail[0], result => {
    formData.append('thumbnail', result, result.name);
  });
  await console.log(base64Image); // await setBody(formData);
};
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("7833b1327bd6339fd3d3")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.d5db9a4149b1627d5308.hot-update.js.map