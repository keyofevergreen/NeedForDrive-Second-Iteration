...
const useCarById = (carId, setValue) => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (cars) {
      ...
      setValue('name', car.name);
      const blob = fetch(car.thumbnail.path).then(r => r.blob()).then(blob => setValue('thumbnail', [blob]));
    }
  }, [cars]);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("9df86258037f53b14331")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.1ed59c7495c986d4b450.hot-update.js.map