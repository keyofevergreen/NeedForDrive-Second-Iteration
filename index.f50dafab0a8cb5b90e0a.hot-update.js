...
const usePointsById = (pointId, setValue) => {
  ...
  const setValuesToForm = async orderStatus => {
    ...
    setValue('cityId', orderStatus === null || orderStatus === void 0 ? void 0 : (_orderStatus$cityId = orderStatus.cityId) === null || _orderStatus$cityId === void 0 ? void 0 : _orderStatus$cityId.id, {
      shouldDirty: true
    });
  };
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("a4492767a04fe484a69d")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.f50dafab0a8cb5b90e0a.hot-update.js.map