  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (cars) {
      async () => {
        ...
        setValue('name', car.name);
        const blob = await fetch(car.thumbnail.path).then(r => r.blob());
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("1ed59c7495c986d4b450")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.6c40711f8f8213430f9f.hot-update.js.map