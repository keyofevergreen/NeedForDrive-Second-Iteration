...
/* harmony export */   "addSuccessAlertMessage": () => (/* binding */ addSuccessAlertMessage),
/* harmony export */   "clearSuccessAlertMessage": () => (/* binding */ clearSuccessAlertMessage)
/* harmony export */ });
...
const addSuccessAlertMessage = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__.createAction)('Success alert has set');
const clearSuccessAlertMessage = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__.createAction)('Success alert cleared');
...
const uploadedEntityReducer = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_1__.createReducer)({
  ...
  [_actions__WEBPACK_IMPORTED_MODULE_0__.addSuccessAlertMessage.type]: (state, {
    payload
  }) => _objectSpread(_objectSpread({}, state), {}, {
    successAlertMessage: payload
  }),
  [_actions__WEBPACK_IMPORTED_MODULE_0__.clearSuccessAlertMessage.type]: (state, {
    payload
  }) => _objectSpread(_objectSpread({}, state), {}, {
    successAlertMessage: null
  })
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("57014f6d4bef89f56d29")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.74d03d8a3064574d1b1f.hot-update.js.map