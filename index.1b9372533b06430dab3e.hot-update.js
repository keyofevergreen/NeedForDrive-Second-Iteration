...
const CarEdit = () => {
  ...
  const uploadLoading = (0,_hooks__WEBPACK_IMPORTED_MODULE_5__.useUploadingCar)();
  const {
    register,
    handleSubmit,
    watch,
  ...
  const onSubmit = async data => {
    ...
    if (newCar && carId) dispatch((0,_store_Cars_thunks__WEBPACK_IMPORTED_MODULE_8__.editCar)(newCar, carId));
    if (newCar) dispatch((0,_store_Cars_thunks__WEBPACK_IMPORTED_MODULE_8__.createCar)(newCar));
  };
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("fbcb0a8eb52a49b21391")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.1b9372533b06430dab3e.hot-update.js.map