...
const getForm = async (form, setBody) => {
  ...
  const base64Image = await (0,_utils_helpers_getBase64__WEBPACK_IMPORTED_MODULE_4__["default"])(form.thumbnail[0], async result => {
    const imageFile = await (0,_utils_helpers_fetchLocalImage__WEBPACK_IMPORTED_MODULE_3__["default"])(result, form.thumbnail[0].name);
    await formData.append('thumbnail', imageFile[0]);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("c21721848e1f70252ede")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.172dfba5e15a69d43928.hot-update.js.map