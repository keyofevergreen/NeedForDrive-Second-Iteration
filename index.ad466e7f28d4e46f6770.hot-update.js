...
const OrderItemStatusButtons = ({
  ...
  const onEditStatus = () => {
    ...
    }, 'order', id, `Статус заказа №${id}, ${carId.name} в ${cityId.name} на ${pointId.address} изменен`));
  };
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("1be4ce09bf03bccc13f2")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.ad466e7f28d4e46f6770.hot-update.js.map