...
const useSaveCar = (form, carId) => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (form) {
      ...
      const imageBlob = carImage.arrayBuffer().then(arrayBuffer => {
        const blob = new Blob([new Uint8Array(arrayBuffer)], {
          type: carImage.type
        });
        formData.append('thumbnail', blob, carImage.name);
        setBody(formData);
      });
    }
  }, [form]);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("d6e48f8104d676abe26a")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.d41c39949576c705e249.hot-update.js.map