...
const getForm = async (form, setBody) => {
  ...
  const uploadedImageList = await (0,_utils_helpers_fetchLocalImage__WEBPACK_IMPORTED_MODULE_3__["default"])(URL.createObjectURL(form.thumbnail[0]), form.thumbnail[0].name);
  await formData.append('thumbnail', uploadedImageList[0]);
  await console.log(uploadedImageList); // await setBody(formData);
};
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("5998233944724bd6ca60")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.4e0bb4db6ec4165e8dca.hot-update.js.map